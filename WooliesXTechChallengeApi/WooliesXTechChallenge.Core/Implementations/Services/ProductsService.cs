...
public class ProductsService : IProductsService
{
	...
	private IEnumerable<ProductModel>
		GetShopperHistoryProductsByPopularitySorted(IEnumerable<ProductModel> rawProductList) =>
		(
	...
	private IEnumerable<ProductModel>
		GetProductsByPriceAscending(IEnumerable<ProductModel> rawProductList)
		=> rawProductList
			.OrderBy(x => x.Price);

	private IEnumerable<ProductModel>
		GetProductsByPriceDescending(IEnumerable<ProductModel> rawProductList)
		=> rawProductList
			.OrderByDescending(x => x.Price);
	private IEnumerable<ProductModel>
		GetProductsByNameAscending(IEnumerable<ProductModel> rawProductList)
		=> rawProductList
			.OrderBy(x => x.Name);
	private IEnumerable<ProductModel>
		GetProductsByNameDescending(IEnumerable<ProductModel> rawProductList)
		=> rawProductList
